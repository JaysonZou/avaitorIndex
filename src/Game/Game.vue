<template>
    <div class="load-txt">
      <div class="loading-game-1">
        <div class="center-loading text-white text-center">
          ...
          <div class="secondary-font f-40 mt-2 waiting-text">
    ...
    <div class="custom-toaster">
      <div class="cashout-toaster1">
        ...
        <div
          class="got-block position-relative d-flex align-items-center justify-content-center"
        >
        ...
        <span class="material-symbols-outlined bold-icon"> close </span>
      </div>
      ...
      <div class="error-toaster1 justify-content-between custom-toaster-error">
        ...
        <span
          class="material-symbols-outlined bold-icon me-2"
          style="color: white"
        >
          close
        </span>
          ...
          <div class="tab-content" id="pills-tabContent">
            ...
            >
              <div class="d-flex align-items-center justify-content-between">
                <div class="bets-count secondary-font f-14">
                  TOTAL BETS :
                  <span class="text-success" id="total_bets">0</span>
                </div>
                <div class="custom-badge mx-auto hide" id="prev_win_multi">
                  0.00x
                </div>
                <div class="">
                  <button
                    class="btn btn-transparent previous-history d-flex align-items-center"
                    id="current_hand_btn"
                    onclick="previous_hand(1);"
                  >
                    <span
              ...
              <div class="list-data-tbl mt-2">
                ...
                <div
                  class="list-body scroll-div list-body0"
                  id="all_bets"
                ></div>

                <div
                  class="list-body scroll-div list-body0 hide"
                  id="prev_bets"
                ></div>
              </div>
            </div>
      ...
      <div class="right-sidebar">
        <div class="game-play">
            ...
            <div class="stats">
              <div class="payouts-wrapper">
                <div class="payouts-block">
                  @foreach ($allresults as $item) @if ($item->result !=
                  'pending' && $item->result != '')
                  <div class="bg1 custom-badge">
              ...
              <div class="button-block">
                ...
                <div class="history-dropdown">
                  <div class="pa-5 secondary-font text-white pb-0">
                    ROUND HISTORY
                  </div>
          ...
          <div class="stage-board">
            <div
              class="counter-num text-center"
              id="auto_increment_number_div"
              style="display: none"
            >
              <div
                class="secondary-font f-40 flew_away_section"
                style="display: none"
              >
                FLEW AWAY!
              </div>
            ...
            <div class="loading-game">
              <div
                class="center-loading text-white text-center game-centeral-loading"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="120"
                ...
                <div class="first-row auto-game-feature">
                  <div class="bet-block">
                    ...
                    <div class="bets-opt-list">
                      <button
                        class="btn btn-secondary btn-sm bet-opt main_amount_btn"
                        onclick="select_direct_bet_amount(this);"
                      >
                  ...
                  <div class="buttons-block" id="bet_button">
                    <button
                      ...
                      onclick="bet_now(this, 0);"
                      id="main_bet_now"
                    >
                      <label class="font-family-title label">BET</label>
                    </button>
                  </div>
                  <div
                    class="buttons-block"
                  ...
                  >
                    ...
                    <button
                      ...
                      onclick="cancle_now(this, 0);"
                      id="main_cancel_now"
                    >
                      <label class="font-family-title label">CANCEL</label>
                    </button>
                  </div>
                  <div
                    class="buttons-block"
                  ...
                  >
                    ...
                    <button
                      class="btn btn-warning bet font-family-title ng-star-inserted"
                      onclick="cash_out_now(this, 0);"
                    >
                      <label class="font-family-title label">CASH OUT</label>
                      <div
                        class="font-family-title label"
                        id="cash_out_amount"
                      ></div>
                    </button>
                  </div>
                ...
                <div class="second-row">
                  ...
                  <div class="cashout-block m-0">
                    <div class="cash-out-switcher">
                      ...
                      >
                        <label class="form-check-label f-12 me-1" for="bet"
                          >Auto Bet</label
                        >
                        <input
                      ...
                      <div
                        class="form-check form-switch lg-switch d-flex align-items-center"
                      >
                        <label class="form-check-label f-12 me-1" for="cashout"
                          >Auto Cash Out</label
                        >
                        <input
                          class="form-check-input m-0"
              ...
              <div class="controls">
                ...
                <div class="first-row auto-game-feature">
                  <div class="bet-block">
                    ...
                    <div class="bets-opt-list">
                      <button
                        class="btn btn-secondary btn-sm bet-opt extra_amount_btn"
                        onclick="select_direct_bet_amount(this);"
                      >
                        <span class="amt">100</span
                        ><span class="currency">₹</span>
    ...
    <div
      ...
      id="game-limit"
      tabindex="-1"
      aria-labelledby="game-limit"
      aria-hidden="true"
    >
      <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title secondary-font" id="exampleModalLabel">
              GAME LIMITS
            </h5>
            <button
              type="button"
          ...
          <div class="modal-body">
            <ul class="list-unstyled limit-rules">
              <li class="list-group-item">
                Minimum Bet:
                <span class="badge badge-success px-2 font-family-number"
                  >10 ₹
                </span>
              </li>
              <li class="list-group-item">
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <div class="list-data-tbl mt-2">
              ...
              <div
                class="list-body scroll-div list-body1"
                id="member_bet"
              ></div>
              <div>
                <button
                  class="btn btn-dark md-btn custm-btn-2 mx-auto mt-3 mb-1"
                  id="load_btn"
                  onclick="loadData()"
                >
                  Load More
    ...
    >
      ...
      >
        <div class="modal-content">
          ...
          <div class="modal-body">
            <p class="text-grey">
              Aviator is a new generation of iGaming entertainment. You can win
              many times more, in seconds! Aviator is built on a provably fair
              system, which is currently the only real guarantee of honesty in
            ...
            <div class="steps-container">
              ...
              <div class="step step-1">
                ...
                <div class="step-text pt-2">
                  <span>CASH OUT</span>before the plane disappears and wins X
                  times more!
                </div>
              </div>
            </div>
            ...
            <ul class="list-unstyled list-ul">
              ...
              <li>
                Press the “Cash Out” button to cash out your winnings. Your win
                is your bet multiplied by the Cash Out multiplier.
              </li>
              <li>
            ...
            <ul class="list-unstyled list-ul">
              <li>
                On the left side of the game interface (or under the Bet Panel
                on mobile), is located the Live Bets panel. Here you can see all
                bets that are being made in the current round.
              </li>
              <li>
              ...
              <li>
                ...
                wins by amount, or Cash Out multiplier, and see the biggest
                round multipliers.
              </li>
            </ul>
            ...
            <ul class="list-unstyled list-ul">
              <li>
                You can check the status of Free Bets, from the Game Menu > Free
                Bets. Free Bets are awarded by the operator, or by the Rain
                Feature.
              </li>
            </ul>
            ...
            <ul class="list-unstyled list-ul">
              ...
              <li>
                You can check and modify the Provably Fair settings from the
                Game menu > Provably Fair settings.
              </li>
              <li>
                You can check the fairness of each round by pressing icon,
                opposite the results in the “My Bets” or inside “Top” tabs.
              </li>
            </ul>
            ...
            <ul class="list-unstyled list-ul">
              <li>
                ...
                active, the game will auto cash out with the current multiplier,
                and the winning amount will be added to your balance.
              </li>
              <li>
                In the event of a malfunction of the gaming hardware/software,
                all affected game bets and payouts are rendered void and all
                affected bets are refunded.
              </li>
            </ul>
          </div>
    ...
    success: function (result) {
      if (result.isSuccess) {
        ...
        if (result.data.notification != "") {
          swal("Notification", result.data.notification, "success").then(
            function () {
              $.ajax({
